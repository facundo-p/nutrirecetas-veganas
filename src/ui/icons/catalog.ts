...
export const ICON_CATALOG: CatalogEntry[] = [
  ...
  { id: 'capsula', Componente: IconCapsula, significado: 'Suplemento declarado en tu perfil', grupo: 'extras' },
  { id: 'hoja-entera', Componente: IconHojaEntera, significado: 'Sección Hoy', grupo: 'navegación' },
