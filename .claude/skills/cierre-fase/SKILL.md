...
3. **Gate de datos** (si la fase lo tiene): actualizar el doc del gate (`docs/plan/faseN-gate-datos.md`) con toda decisión de datos tomada a mano, con columna "¿OK?" para que Facu marque.
...
5. **Roadmap**: marcar el avance en `docs/plan/05-roadmap.md` (✅ en lo hecho, mover el "acá estamos").
6. **Commit** de todo lo anterior en `staging` (jamás en `main`).
...
Recordatorios duros:
- `main` solo recibe PRs aprobados por Facu (v1 = cierre de Fase 4).
